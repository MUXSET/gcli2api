...
class StorageAdapter:
    ...
    async def initialize(self) -> None:
        ...
        async with self._lock:
            ...
            # 2. 其次尝试MySQL (推荐的关系型数据库，与UserManager一致)
            if not self._backend and mysql_uri:
                try:
                    ...
                    log.error(f"Failed to import MySQL backend: {e}")
                except Exception as e:
